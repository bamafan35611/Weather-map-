...
This fixes the issue where the system only looks at alerts, not forecasts
"""
...
class NWSForecastFetcher:
    ...
    def is_severe_weather_expected(self, forecast_data: Dict) -> bool:
        ...
        for period in forecast_data['periods'][:3]:
            ...
            if any(keyword in forecast_text for keyword in severe_keywords):
                return True
    ...
    def get_athensforecast_specifically(self) -> str:
        """
        ...
        if not forecast:
            return "Athens, Alabama forecast is currently unavailable."
...
if __name__ == '__main__':
    ...
    if forecast:
        print(f"✓ Forecast retrieved, updated: {forecast['updated']}")
